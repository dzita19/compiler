...
assignment_expression
  : conditional_expression
  | unary_expression '=' assignment_expression 					{ SimpleAssignExpr(0); }
...
init_declarator
  ...
  | declarator_initialized '=' initializer  { NotFunctionDefinition(); FullInitialization(); NotCompoundLiteral(); }
  ;
